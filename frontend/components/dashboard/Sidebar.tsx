...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-64 bg-white border-r border-slate-200 flex flex-col justify-between p-4 md:h-screen sticky top-0 shadow-sm">
      ...
      <div className="pt-4 border-t border-slate-200 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-bold text-slate-500 hover:text-rose-600 rounded-lg transition-colors text-left"
        >
